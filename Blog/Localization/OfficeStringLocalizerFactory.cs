...
{
    public class OfficeStringLocalizerFactory : IStringLocalizerFactory
    {
        ...
        public OfficeStringLocalizerFactory(IOptions<LocalizationConfigSection> localizationConfigSection)
        {
        ...
        {
            var officeStringLocalizer = new OfficeStringLocalizer(GetAllFromOfficeFile(resourceName), resourceName);
